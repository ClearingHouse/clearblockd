...
from lib.components import betting, rps, assets, assets_trading, dex, notary
...
def serve_api(mongo_db, redis_client):
    ...
    def get_users_pairs(addresses=[], max_pairs=12):
        return dex.get_users_pairs(addresses, max_pairs, quote_assets=['XCH', 'XVIA'])
    ...
    def get_documents_for(addresses):
        return notary.get_documents_for(addresses)
